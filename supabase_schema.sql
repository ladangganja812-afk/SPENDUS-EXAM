...
-- Disable RLS to allow easy setup (Ensure all of these run)
...
-- If RLS is enforced by Supabase UI, let's create policies allowing public access just in case
CREATE POLICY "Allow public access to settings" ON settings FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to staff" ON staff FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to exam_sessions" ON exam_sessions FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to students" ON students FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to subjects" ON subjects FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to questions" ON questions FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to results" ON results FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow public access to student_exam_mapping" ON student_exam_mapping FOR ALL USING (true) WITH CHECK (true);
